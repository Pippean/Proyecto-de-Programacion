...
public class Mayusculas {
    ...
    public void dibujarG(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                G.moveTo(40+x, 143+y);
                G.curveTo(60+x, 143+y, 70+x, 110+y, 80+x, 100+y);
                G.moveTo(80+x, 100+y);
                G.curveTo(80+x, 100+y, 80+x, 180+y, 50+x, 180+y);
                G.moveTo(50+x, 180+y);
                G.curveTo(35+x, 183+y, 20+x, 180+y, 50+x, 160+y);
                G.moveTo(50+x, 160+y);
       ...
       int limite = 1;
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                I.moveTo(50+x,55+y);
                I.curveTo(40+x,170+y,0+x,170+y,0+x,130+y);
            }
            else{
                I.moveTo(0+x,55+y);
                I.curveTo(0+x,65+y,40+x,65+y,50+x,55+y);
    ...
    public void dibujarL(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                L.moveTo(55+x, 55+y);
                L.curveTo(40+x, 65+y, 50+x, 110+y, 25+x, 130+y);
                L.moveTo(25+x, 130+y);       
                L.curveTo(-5+x, 160+y, 0+x, 128+y, 20+x, 130+y);
                L.moveTo(20+x, 130+y);       
                L.curveTo(45+x, 130+y, 55+x, 145+y, 80+x, 143+y);
            }
            else{
                L.moveTo(30+x, 65+y);
                L.curveTo(5+x, 68+y, 0+x, 60+y, 10+x, 57+y);
    ...
    public void dibujarM(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                M.moveTo(55+x, 55+y);
                M.curveTo(45+x, 65+y, 45+x, 110+y, 27+x, 130+y);
                M.moveTo(27+x, 130+y);       
                M.curveTo(10+x, 160+y, -20+x, 128+y, 10+x, 130+y);
                M.moveTo(55+x, 55+y);       
                M.curveTo(48+x, 55+y, 52+x, 143+y, 55+x, 143+y);
                M.moveTo(55+x, 143+y);       
                M.curveTo(62+x, 143+y, 85+x, 55+y, 95+x, 55+y);
                M.moveTo(95+x, 55+y);       
    ...
    public void dibujarP(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                P.moveTo(10+x,143+y);
                P.curveTo(0+x,143+y,0+x,80+y,20+x,70+y);
                P.moveTo(20+x,70+y);
    ...
    public void dibujarR(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                R.moveTo(10+x,143+y);
                R.curveTo(0+x,143+y,0+x,80+y,20+x,70+y);
                R.moveTo(20+x,70+y);
                R.curveTo(22+x,65+y,60+x,50+y,70+x, 55+y);
                R.moveTo(70+x,55+y);
    ...
    public void dibujarT(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                T.moveTo(35+x, 60+y);
                T.curveTo(0+x,60+y,0+x,20+y,70+x,55+y);
                T.moveTo(70+x,55+y);
    ...
    public void dibujarV(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                V.moveTo(40+x,100+y);
                V.curveTo(50+x,200+y,85+x,100+y,95+x,55+y);
            }
            else{
                V.moveTo(25+x, 75+y);
                V.curveTo(0+x,85+y,40+x,15+y,40+x,100+y);
    ...
    public void dibujarW(Graphics2D g2, int x, int y, boolean bandera,boolean negrita, boolean subrayado, boolean cursiva){
        ...
        for(int i = 0; i<limite;i++){
            if(cursiva==true){
                ...
                W.moveTo(60+x,100+y);
                W.curveTo(60+x,225+y,70+x,80+y,90+x,70+y);
            }
            else{
                W.moveTo(25+x, 75+y);
                W.curveTo(0+x,85+y,40+x,15+y,40+x,100+y);
