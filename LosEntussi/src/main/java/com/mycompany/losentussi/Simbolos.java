...
public class Simbolos {
    ...
    public void interrogacionabierto(Graphics2D g2, int x, int y,boolean bandera){
    ...
    public void interrogacioncerrado(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(30+x, 30+y);
    ...
    public void exclamacionabierto(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(30+x, 30+y);
    ...
    public void exclamacioncerrado(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(30+x, 163+y);
    ...
    public void coma(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(28+x, 136+y);
    ...
    public void puntoycoma(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
    ...
    public void comillasinglesas(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(28+x, 53+y);
        s.curveTo(28+x, 53+y, 28+x, 65+y, 25+x, 73+y);
        g2.fillOval(20+x,50+y,10,10);
    ...
    public void españolaabierta(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(10+x, 120+y);
    ...
    public void españolacerrada(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(10+x, 140+y);
    ...
    public void parentesisabierto(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(25+x, 40+y);
    ...
    public void parentesiscerrado(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(25+x, 40+y);
    ...
    public void llavesabiertas(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(30+x, 140+y);
    ...
    public void llavescerradas(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(5+x, 40+y);
    ...
    public void guionbajo(Graphics2D g2, int x, int y,boolean bandera){
        Path2D.Double s = new Path2D.Double();
        s.moveTo(5+x, 143+y);
